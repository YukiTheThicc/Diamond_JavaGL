...
public class MouseListener {
    ...
    public static void mousePosCallback(long window, double xpos, double ypos) {
        if (!Window.getImGuiLayer().getViewPortWindow().getWantCaptureMouse()) {
            clear();
        }
    ...
    public static Vector2f worldToScreen(Vector2f worldCoords) {
        ...
        Matrix4f view = new Matrix4f(camera.getvMatrix());
        Matrix4f projection = new Matrix4f(camera.getpMatrix());
